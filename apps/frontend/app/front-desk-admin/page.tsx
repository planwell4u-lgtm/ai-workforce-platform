  ...
  async function loadDestinations() {
    ...
    try {
      ...
      if (destinationResponse.status === 403 || requestResponse.status === 403) {
        ...
        setNotice("Administrator access is not enabled in this sign-in session. Sign in again to request Front Desk access.");
        return;
      }
